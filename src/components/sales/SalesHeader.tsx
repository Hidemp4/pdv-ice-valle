...
export const SalesHeader: React.FC = () => {
  return (
    <div className="flex items-center mb-6">
      <div className="flex items-center justify-center rounded-lg h-16 w-16 border border-gray-300 bg-white shadow-sm">
        {/* Ícone SVG otimizado */}
        <svg
          width="34"
          height="34"
      ...
      <div className="flex flex-col p-4">
        <h1 className="font-bold text-3xl text-gray-900 tracking-tight">Relatório de Vendas</h1>
        <p className="text-brand-blue text-sm font-semibold">Ice Valle PDV</p>
      </div>
    </div>
  );
};